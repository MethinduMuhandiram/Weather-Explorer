...
app.post('/', function(req, res){
  ...
  const units = "metric";
  const url = "https://api.openweathermap.org/data/2.5/weather?q="+searchCity+"&appid="+appid+"&units="+units;
  ...
  https.get(url, function(response){
    response.on('data', function(data){
      ...
      res.render('weatherResult', {searchCity: searchCity, temp: temp, imageUrl: imageUrl, weatherDescription: weatherDescription});
